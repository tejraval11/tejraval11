...
* React.js, Redux, Tailwind CSS, Material UI
...
* AWS (S3, EC2, Lambda), GCP, Render, Vercel, Docker, Kubernetes, CI/CD

### AI & Machine Learning

* LangChain, OpenAI API, Hugging Face, Agentic AI
...
* 📧 **Email**: [tejraval.connect@gmail.com](mailto:tejraval.connect@gmail.com)
* 💻 **Portfolio**: [portfolio-tejraval.vercel.app](https://portfolio-tejraval.vercel.app/)
* 👔 **LinkedIn**: [linkedin.com/in/tej-raval-a9a006374](https://www.linkedin.com/in/tej-raval-a9a006374/)
